...
- [x] **조인 2 — 외부 조인** — 완료 (2026-07-23) · [학습 기록](notes/join2_외부조인.md)
- [x] **서브쿼리** — 완료 (2026-07-23) · [학습 기록](notes/subquery_서브쿼리.md)
- [x] **UNION / UNION ALL / UNION 정렬** — 완료 (2026-07-23) · [학습 기록](notes/union_유니온.md)
- [x] **CASE 문** — 완료 (2026-07-23) · [학습 기록](notes/case_케이스문.md)
- [x] **뷰(View)** — 완료 (2026-07-23) · [학습 기록](notes/view_뷰.md)
- [x] **인덱스 1** — 완료 (2026-07-23) · [학습 기록](notes/index1_인덱스기초.md)
- [ ] **인덱스 2** — 옵티마이저, 커버링·복합 인덱스, 설계 가이드라인, 단점 ← 현재 진행
